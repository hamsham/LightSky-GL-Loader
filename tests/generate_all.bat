...
python ..\glloader.py -i ..\GL\gl.h -o .\
@ECHO Done.
...
gcc --std=c99 -pedantic -pedantic-errors -Wall -Werror -Wextra -O2 -I.\ -g lsgl_test.c -o lsgl_test -L.\ -llsgl_d -lSDL2main -lSDL2 -lopengl
@ECHO Done.
